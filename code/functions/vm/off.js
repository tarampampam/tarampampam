export async function onRequestPost(context) {
  ...
  try {
    await fetch( // https://docs.hetzner.cloud/#server-actions-power-off-a-server
      new Request(`https://api.hetzner.cloud/v1/servers/${env.HCLOUD_CODESPACE_SERVER_ID}/actions/poweroff`),
      {
        method: 'POST',
        headers: {
