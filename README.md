...
- [urfave/cli](https://github.com/urfave/cli) ([v2.27.2](https://github.com/urfave/cli/releases/tag/v2.27.2), 3 days ago) - A simple, fast, and fun package for building command line apps in Go
- [gacts/install-hurl](https://github.com/gacts/install-hurl) ([v1.1.1](https://github.com/gacts/install-hurl/releases/tag/v1.1.1), 3 days ago) - 🚀 Installs hurl binary file into your actions workflow
...
- [Fix the binary files path (resolves #78)](https://github.com/gacts/install-hurl/pull/79) on [gacts/install-hurl](https://github.com/gacts/install-hurl) (3 days ago)
