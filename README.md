...
- [roadrunner-php/laravel-bridge](https://github.com/roadrunner-php/laravel-bridge) - Complete Laravel integration for RoadRunner with support for HTTP, Jobs, gRPC, and Temporal plugins - going beyond Octane&#39;s capabilities (3 weeks ago)
...
- [jetexe/gobuf-docker](https://github.com/jetexe/gobuf-docker) ([v1.55.1](https://github.com/jetexe/gobuf-docker/releases/tag/v1.55.1), 5 days ago) - docker image for buf with golang extensions
...
- [linkedin/goavro](https://github.com/linkedin/goavro) - Goavro is a library that encodes and decodes Avro data. (4 days ago)
