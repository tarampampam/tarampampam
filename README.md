...
- [go-playground/validator](https://github.com/go-playground/validator) ([v10.20.0](https://github.com/go-playground/validator/releases/tag/v10.20.0), 1 day ago) - :100:Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving
- [urfave/cli](https://github.com/urfave/cli) ([v2.27.2](https://github.com/urfave/cli/releases/tag/v2.27.2), 4 days ago) - A simple, fast, and fun package for building command line apps in Go
- [gacts/install-hurl](https://github.com/gacts/install-hurl) ([v1.1.1](https://github.com/gacts/install-hurl/releases/tag/v1.1.1), 4 days ago) - 🚀 Installs hurl binary file into your actions workflow
- [tarampampam/3proxy-docker](https://github.com/tarampampam/3proxy-docker) ([v1.9.1](https://github.com/tarampampam/3proxy-docker/releases/tag/v1.9.1), 4 weeks ago) - :calling: Docker image with 3proxy - Tiny free proxy server

#### 🔨 Latest Pull Requests I published


- [Fix the binary files path (resolves #78)](https://github.com/gacts/install-hurl/pull/79) on [gacts/install-hurl](https://github.com/gacts/install-hurl) (4 days ago)
