...
- [tarampampam/evans-docker](https://github.com/tarampampam/evans-docker) - 🛠 Docker image with evans - more expressive universal gRPC client (1 day ago)
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) - hydra (4 days ago)
...
- [tarampampam/arduino-elscooter-lighting](https://github.com/tarampampam/arduino-elscooter-lighting) - :nut_and_bolt: My electric scooter lighting firmware (5 days ago)
...
- [tarampampam/evans-docker](https://github.com/tarampampam/evans-docker) ([v0.10.6](https://github.com/tarampampam/evans-docker/releases/tag/v0.10.6), 1 day ago) - 🛠 Docker image with evans - more expressive universal gRPC client
- [tarampampam/random-user-agent](https://github.com/tarampampam/random-user-agent) ([v3.8.0](https://github.com/tarampampam/random-user-agent/releases/tag/v3.8.0), 5 days ago) - 😎 Browser extension that automatically replaces the User-Agent with a randomized one
- [roadrunner-server/roadrunner](https://github.com/roadrunner-server/roadrunner) ([v2.10.4](https://github.com/roadrunner-server/roadrunner/releases/tag/v2.10.4), 1 week ago) - 🤯 High-performance PHP application server, process manager written in Go and powered with plugins
...
- [Hydra docker image](https://github.com/vanhauser-thc/thc-hydra/pull/767) on [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) (4 days ago)
- [Action prototype wrote](https://github.com/gacts/docker-image-exists/pull/1) on [gacts/docker-image-exists](https://github.com/gacts/docker-image-exists) (4 weeks ago)
...
- [Searching for config file inside .github dir added](https://github.com/gacts/gitleaks/pull/2) on [gacts/gitleaks](https://github.com/gacts/gitleaks) (1 month ago)

#### ⭐ Recent stars


- [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) - Find credentials all over the place (1 day ago)
- [larryhe/tinyhttpd](https://github.com/larryhe/tinyhttpd) - This is a github mirror of thttpd (http://www.acme.com/software/thttpd/) (3 days ago)
