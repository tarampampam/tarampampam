...
- [laravel/octane](https://github.com/laravel/octane) ([v1.0.18](https://github.com/laravel/octane/releases/tag/v1.0.18), 1 day ago) - Supercharge your Laravel application&#39;s performance.
- [spiral/roadrunner-binary](https://github.com/spiral/roadrunner-binary) ([v2.5.6](https://github.com/spiral/roadrunner-binary/releases/tag/v2.5.6), 3 days ago) - 💾 High-performance PHP application server, load-balancer and process manager written in Golang. RR2 releases repository.
- [spiral/roadrunner](https://github.com/spiral/roadrunner) ([v2.5.3](https://github.com/spiral/roadrunner/releases/tag/v2.5.3), 3 days ago) - 🤯 High-performance PHP application server, load-balancer and process manager written in Golang
- [nasa/fprime](https://github.com/nasa/fprime) ([v3.0.0-RC1](https://github.com/nasa/fprime/releases/tag/v3.0.0-RC1), 5 days ago) - F&#39; - A flight software and embedded systems framework
