...
- [gacts/run-and-post-run](https://github.com/gacts/run-and-post-run) ([v1.3.0](https://github.com/gacts/run-and-post-run/releases/tag/v1.3.0), 2 days ago) - 🚀 A simple GitHub action that allows you to execute commands on place and in post-run, once a workflow job has ended.
- [urfave/cli](https://github.com/urfave/cli) ([v1.22.14](https://github.com/urfave/cli/releases/tag/v1.22.14), 6 days ago) - A simple, fast, and fun package for building command line apps in Go
