...
- [StackExchange/dnscontrol](https://github.com/StackExchange/dnscontrol) ([v3.30.0](https://github.com/StackExchange/dnscontrol/releases/tag/v3.30.0), 3 days ago) - Synchronize your DNS to multiple providers from a simple DSL
...
- [di-sukharev/opencommit](https://github.com/di-sukharev/opencommit) - GPT CLI to auto-generate impressive commits in 1 second 🤯🔫 (3 days ago)
- [allegro/bigcache](https://github.com/allegro/bigcache) - Efficient cache for gigabytes of data written in Go. (6 days ago)
