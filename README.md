...
- [spiral/roadrunner-binary](https://github.com/spiral/roadrunner-binary) ([v2.5.6](https://github.com/spiral/roadrunner-binary/releases/tag/v2.5.6), 1 day ago) - 💾 High-performance PHP application server, load-balancer and process manager written in Golang. RR2 releases repository.
- [spiral/roadrunner](https://github.com/spiral/roadrunner) ([v2.5.3](https://github.com/spiral/roadrunner/releases/tag/v2.5.3), 1 day ago) - 🤯 High-performance PHP application server, load-balancer and process manager written in Golang
- [nasa/fprime](https://github.com/nasa/fprime) ([v3.0.0-RC1](https://github.com/nasa/fprime/releases/tag/v3.0.0-RC1), 3 days ago) - F&#39; - A flight software and embedded systems framework
- [laravel/octane](https://github.com/laravel/octane) ([v1.0.17](https://github.com/laravel/octane/releases/tag/v1.0.17), 6 days ago) - Supercharge your Laravel application&#39;s performance.
- [avto-dev/static-references-data](https://github.com/avto-dev/static-references-data) ([v3.7.0](https://github.com/avto-dev/static-references-data/releases/tag/v3.7.0), 6 days ago) - Data for static references
