...
- [StackExchange/dnscontrol](https://github.com/StackExchange/dnscontrol) ([v3.27.1](https://github.com/StackExchange/dnscontrol/releases/tag/v3.27.1), 2 days ago) - Synchronize your DNS to multiple providers from a simple DSL
- [tarampampam/random-user-agent](https://github.com/tarampampam/random-user-agent) ([v3.16.2](https://github.com/tarampampam/random-user-agent/releases/tag/v3.16.2), 3 days ago) - 😎 Browser extension that automatically replaces the User-Agent with a randomized one
- [ktr0731/evans](https://github.com/ktr0731/evans) ([v0.10.11](https://github.com/ktr0731/evans/releases/tag/v0.10.11), 4 days ago) - Evans: more expressive universal gRPC client
- [gacts/purge-jsdelivr-cache](https://github.com/gacts/purge-jsdelivr-cache) ([v1.0.2](https://github.com/gacts/purge-jsdelivr-cache/releases/tag/v1.0.2), 6 days ago) - 🚀 GitHub action for the jsDelivr cache purging
...
- [feat: Domains definition using JS](https://github.com/tarampampam/free-domains/pull/109) on [tarampampam/free-domains](https://github.com/tarampampam/free-domains) (3 weeks ago)
