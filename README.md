...
- [jetexe/gobuf-docker](https://github.com/jetexe/gobuf-docker) ([v1.53.0](https://github.com/jetexe/gobuf-docker/releases/tag/v1.53.0), 3 weeks ago) - docker image for buf with golang extensions
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.13.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.13.0), 1 month ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
...
- [gacts/directory-listing](https://github.com/gacts/directory-listing) ([v1.0.1](https://github.com/gacts/directory-listing/releases/tag/v1.0.1), 2 months ago) - 🚀 GitHub Action to generate `index.html` files for directory listings

#### 🔨 Latest Pull Requests I published


- [✨ feat(glance): Update glance configuration and add new widgets](https://github.com/iddqd-uk/apps/pull/42) on [iddqd-uk/apps](https://github.com/iddqd-uk/apps) (2 days ago)
...
- [tsndr/cloudflare-worker-router](https://github.com/tsndr/cloudflare-worker-router) - A super lightweight router (1.0K) with middleware support and ZERO dependencies for Cloudflare Workers. (2 months ago)
