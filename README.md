...
- [nasa/fprime](https://github.com/nasa/fprime) ([v3.0.0-RC2](https://github.com/nasa/fprime/releases/tag/v3.0.0-RC2), 6 days ago) - F&#39; - A flight software and embedded systems framework
- [laravel/octane](https://github.com/laravel/octane) ([v1.0.19](https://github.com/laravel/octane/releases/tag/v1.0.19), 1 week ago) - Supercharge your Laravel application&#39;s performance.
...
- [spiral/roadrunner](https://github.com/spiral/roadrunner) ([v2.5.3](https://github.com/spiral/roadrunner/releases/tag/v2.5.3), 2 weeks ago) - 🤯 High-performance PHP application server, load-balancer and process manager written in Golang
