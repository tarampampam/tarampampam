...
- [urfave/cli](https://github.com/urfave/cli) ([v2.25.7](https://github.com/urfave/cli/releases/tag/v2.25.7), 3 days ago) - A simple, fast, and fun package for building command line apps in Go
- [gacts/run-and-post-run](https://github.com/gacts/run-and-post-run) ([v1.3.0](https://github.com/gacts/run-and-post-run/releases/tag/v1.3.0), 6 days ago) - 🚀 A simple GitHub action that allows you to execute commands on place and in post-run, once a workflow job has ended.
