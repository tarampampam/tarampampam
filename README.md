...
- [nasa/fprime](https://github.com/nasa/fprime) ([v3.0.0-RC2](https://github.com/nasa/fprime/releases/tag/v3.0.0-RC2), 2 days ago) - F&#39; - A flight software and embedded systems framework
- [laravel/octane](https://github.com/laravel/octane) ([v1.0.19](https://github.com/laravel/octane/releases/tag/v1.0.19), 3 days ago) - Supercharge your Laravel application&#39;s performance.
- [spiral/roadrunner-binary](https://github.com/spiral/roadrunner-binary) ([v2.5.7](https://github.com/spiral/roadrunner-binary/releases/tag/v2.5.7), 6 days ago) - 💾 High-performance PHP application server, load-balancer and process manager written in Golang. RR2 releases repository.
