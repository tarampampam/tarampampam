...
- [tarampampam/microcheck](https://github.com/tarampampam/microcheck) ([v1.4.0-rc1](https://github.com/tarampampam/microcheck/releases/tag/v1.4.0-rc1), 5 days ago) - 🧪 Lightweight health check utilities for Docker containers
...
- [Allow custom homepage URL in error pages](https://github.com/tarampampam/error-pages/pull/392) on [tarampampam/error-pages](https://github.com/tarampampam/error-pages) (5 days ago)
- [feat: Add connection timeout flag for http(s)check](https://github.com/tarampampam/microcheck/pull/19) on [tarampampam/microcheck](https://github.com/tarampampam/microcheck) (5 days ago)
