...
- [tarampampam/describe-commit](https://github.com/tarampampam/describe-commit) ([v0.1.8](https://github.com/tarampampam/describe-commit/releases/tag/v0.1.8), 1 day ago) - 🪇 CLI tool that leverages AI to generate commit messages based on changes made in a Git repository
...
- [feat(ai): Add OpenRouter support for AI provider integration](https://github.com/tarampampam/describe-commit/pull/11) on [tarampampam/describe-commit](https://github.com/tarampampam/describe-commit) (2 days ago)
- [chore(ci): Enhance release process](https://github.com/tarampampam/describe-commit/pull/9) on [tarampampam/describe-commit](https://github.com/tarampampam/describe-commit) (4 days ago)
- [chore(ci): Migrate to Goreleaser for build and release process](https://github.com/tarampampam/describe-commit/pull/8) on [tarampampam/describe-commit](https://github.com/tarampampam/describe-commit) (4 days ago)
