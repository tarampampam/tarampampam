...
- [StackExchange/dnscontrol](https://github.com/StackExchange/dnscontrol) ([v3.29.1](https://github.com/StackExchange/dnscontrol/releases/tag/v3.29.1), 2 days ago) - Synchronize your DNS to multiple providers from a simple DSL
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.0.1](https://github.com/tarampampam/curl-docker/releases/tag/v8.0.1), 5 days ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
...
- [h2non/filetype](https://github.com/h2non/filetype) - Fast, dependency-free Go package to infer binary file types based on the magic numbers header signature (2 days ago)
