...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v4.2.1](https://github.com/tarampampam/error-pages/releases/tag/v4.2.1), 2 days ago) - 🪂 Tiny, zero-dep HTTP server &amp; Docker image serving pretty, themeable, localized HTTP error pages — drop-in for Traefik, Nginx, Kubernetes, and more
...
- [[GHSA-h524-452v-82p9] Decoding a maliciously-crafted MIME header containing...](https://github.com/github/advisory-database/pull/7909) on [github/advisory-database](https://github.com/github/advisory-database) (2 days ago)
