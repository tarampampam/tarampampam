...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v2.25.0](https://github.com/tarampampam/error-pages/releases/tag/v2.25.0), 1 day ago) - 🚧 Pretty server&#39;s error pages in the docker image &amp; git repository (for traefik, k8s, nginx and so on)
- [StackExchange/dnscontrol](https://github.com/StackExchange/dnscontrol) ([v4.3.0](https://github.com/StackExchange/dnscontrol/releases/tag/v4.3.0), 5 days ago) - Synchronize your DNS to multiple providers from a simple DSL
