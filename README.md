...
- [jetexe/gobuf-docker](https://github.com/jetexe/gobuf-docker) ([v1.57.2](https://github.com/jetexe/gobuf-docker/releases/tag/v1.57.2), 2 days ago) - docker image for buf with golang extensions
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.16.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.16.0), 5 days ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
