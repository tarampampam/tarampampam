...
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.5.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.5.0), 4 days ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
- [urfave/cli](https://github.com/urfave/cli) ([v3.0.0-alpha6](https://github.com/urfave/cli/releases/tag/v3.0.0-alpha6), 6 days ago) - A simple, fast, and fun package for building command line apps in Go
