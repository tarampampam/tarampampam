...
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.11.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.11.0), 6 days ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
...
- [feat(storage): SQLite storage driver](https://github.com/tarampampam/webhook-tester/pull/597) on [tarampampam/webhook-tester](https://github.com/tarampampam/webhook-tester) (6 days ago)
