...
- [gacts/gitleaks](https://github.com/gacts/gitleaks) ([v1.3.0](https://github.com/gacts/gitleaks/releases/tag/v1.3.0), 3 days ago) - 🚀 GitHub action for running gitleaks/gitleaks (no license key is required)
...
- [⬆️ chore: Upgrade dependencies and Node version to 24](https://github.com/gacts/github-slug/pull/83) on [gacts/github-slug](https://github.com/gacts/github-slug) (3 days ago)
- [⬆️ chore: Upgrade to Node 24](https://github.com/tarampampam/random-user-agent/pull/690) on [tarampampam/random-user-agent](https://github.com/tarampampam/random-user-agent) (3 days ago)
