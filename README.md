...
- [gacts/install-dnscontrol](https://github.com/gacts/install-dnscontrol) - 🚀 Installs DNSControl into your actions workflow (2 months ago)
...
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.6.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.6.0), 2 days ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
...
- [qax-os/excelize](https://github.com/qax-os/excelize) - Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets (1 week ago)
