...
- [gacts/install-geth-tools](https://github.com/gacts/install-geth-tools) - 🚀 Installs Geth (Go Ethereum) and tools (abigen, bootnode, clef, evm, rlpdump) into your actions workflow (4 days ago)
...
- [gacts/install-hurl](https://github.com/gacts/install-hurl) ([v1.2.0](https://github.com/gacts/install-hurl/releases/tag/v1.2.0), 2 days ago) - 🚀 Installs hurl binary file into your actions workflow
- [gacts/install-podman](https://github.com/gacts/install-podman) ([v1.1.1](https://github.com/gacts/install-podman/releases/tag/v1.1.1), 4 days ago) - 🚀 Installs Podman into your actions workflow
- [gacts/setup-node-with-cache](https://github.com/gacts/setup-node-with-cache) ([v1.2.2](https://github.com/gacts/setup-node-with-cache/releases/tag/v1.2.2), 4 days ago) - 🚀 Setup a Node environment, additionally enable caching
- [gacts/github-slug](https://github.com/gacts/github-slug) ([v1.3.1](https://github.com/gacts/github-slug/releases/tag/v1.3.1), 4 days ago) - 🚀 GitHub Action to expose slug values of branch/tag/version inside your GitHub workflow

#### 🔨 Latest Pull Requests I published


- [Deprecate the action](https://github.com/gacts/install-podman/pull/4) on [gacts/install-podman](https://github.com/gacts/install-podman) (4 days ago)
- [Refactoring](https://github.com/gacts/github-slug/pull/75) on [gacts/github-slug](https://github.com/gacts/github-slug) (4 days ago)
- [Switch from yarn to npm and refactor the action code](https://github.com/gacts/is-stargazer/pull/45) on [gacts/is-stargazer](https://github.com/gacts/is-stargazer) (4 days ago)
- [Switch from yarn to npm and refactor the action code](https://github.com/gacts/purge-jsdelivr-cache/pull/58) on [gacts/purge-jsdelivr-cache](https://github.com/gacts/purge-jsdelivr-cache) (4 days ago)
