...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v3.0.0-alpha-1](https://github.com/tarampampam/error-pages/releases/tag/v3.0.0-alpha-1), 2 days ago) - 🚧 Pretty server&#39;s error pages in the docker image &amp; git repository (for traefik, k8s, nginx and so on)
...
- [V3](https://github.com/tarampampam/error-pages/pull/287) on [tarampampam/error-pages](https://github.com/tarampampam/error-pages) (2 days ago)
