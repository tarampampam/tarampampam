...
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.9.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.9.0), 2 days ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
...
- [paulpacifico/shutter-encoder](https://github.com/paulpacifico/shutter-encoder) - A professional video compression tool accessible to all, mostly based on FFmpeg. (6 days ago)
- [mifi/lossless-cut](https://github.com/mifi/lossless-cut) - The swiss army knife of lossless video/audio editing (6 days ago)
