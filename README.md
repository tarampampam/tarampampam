...
- [tarampampam/describe-commit](https://github.com/tarampampam/describe-commit) ([v0.1.5](https://github.com/tarampampam/describe-commit/releases/tag/v0.1.5), 2 days ago) - 🪇 CLI tool that leverages AI to generate commit messages based on changes made in a Git repository
...
- [New cli iface](https://github.com/tarampampam/describe-commit/pull/7) on [tarampampam/describe-commit](https://github.com/tarampampam/describe-commit) (5 days ago)
...
- [yusing/godoxy](https://github.com/yusing/godoxy) - Easy to use reverse proxy with docker integration (2 weeks ago)
