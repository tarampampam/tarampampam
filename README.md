...
- [tarampampam/tinifier](https://github.com/tarampampam/tinifier) - 🐼 CLI tool for compressing images using the TinyPNG (5 days ago)
...
- [tarampampam/tinifier](https://github.com/tarampampam/tinifier) ([v5.1.0](https://github.com/tarampampam/tinifier/releases/tag/v5.1.0), 5 days ago) - 🐼 CLI tool for compressing images using the TinyPNG
...
- [✨ feat: Add option to keep original file after compression](https://github.com/tarampampam/tinifier/pull/183) on [tarampampam/tinifier](https://github.com/tarampampam/tinifier) (5 days ago)
