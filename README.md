...
- [tarampampam/tinifier](https://github.com/tarampampam/tinifier) - 🐼 CLI tool for compressing images using the TinyPNG (6 days ago)
...
- [tarampampam/tinifier](https://github.com/tarampampam/tinifier) ([v5.1.0](https://github.com/tarampampam/tinifier/releases/tag/v5.1.0), 6 days ago) - 🐼 CLI tool for compressing images using the TinyPNG
- [tarampampam/curl-docker](https://github.com/tarampampam/curl-docker) ([v8.15.0](https://github.com/tarampampam/curl-docker/releases/tag/v8.15.0), 1 week ago) - :mechanical_arm: curl (static binary file) in a scratch docker image
...
- [✨ feat: Add option to keep original file after compression](https://github.com/tarampampam/tinifier/pull/183) on [tarampampam/tinifier](https://github.com/tarampampam/tinifier) (6 days ago)
