...
- [tarampampam/random-user-agent](https://github.com/tarampampam/random-user-agent) ([v4.0.2](https://github.com/tarampampam/random-user-agent/releases/tag/v4.0.2), 5 days ago) - 😎 Browser extension that automatically replaces the User-Agent with a randomized one
...
- [feat: Add option to disable stats collecting](https://github.com/tarampampam/random-user-agent/pull/585) on [tarampampam/random-user-agent](https://github.com/tarampampam/random-user-agent) (1 day ago)
