...
- [urfave/cli](https://github.com/urfave/cli) ([v3.0.0-alpha8](https://github.com/urfave/cli/releases/tag/v3.0.0-alpha8), 1 day ago) - A simple, fast, and fun package for building command line apps in Go
- [temporalio/sdk-php](https://github.com/temporalio/sdk-php) ([v2.7.0](https://github.com/temporalio/sdk-php/releases/tag/v2.7.0), 5 days ago) - Temporal PHP SDK
