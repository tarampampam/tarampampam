...
- [laravel/octane](https://github.com/laravel/octane) ([v1.2.1](https://github.com/laravel/octane/releases/tag/v1.2.1), 1 day ago) - Supercharge your Laravel application&#39;s performance.
- [roadrunner-server/roadrunner](https://github.com/roadrunner-server/roadrunner) ([v2.7.6](https://github.com/roadrunner-server/roadrunner/releases/tag/v2.7.6), 3 days ago) - 🤯 High-performance PHP application server, load-balancer and process manager written in Golang
- [tarampampam/hydra-docker](https://github.com/tarampampam/hydra-docker) ([v9.3.0](https://github.com/tarampampam/hydra-docker/releases/tag/v9.3.0), 6 days ago) - :octopus: Dockerized hydra application
...
- [tarampampam/random-user-agent](https://github.com/tarampampam/random-user-agent) ([v3.6.0](https://github.com/tarampampam/random-user-agent/releases/tag/v3.6.0), 1 week ago) - 😎 Browser extension that automatically replaces the User-Agent with a randomized one
