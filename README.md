...
- [roadrunner-server/roadrunner](https://github.com/roadrunner-server/roadrunner) ([v2.7.7](https://github.com/roadrunner-server/roadrunner/releases/tag/v2.7.7), 2 days ago) - 🤯 High-performance PHP application server, load-balancer and process manager written in Golang
- [spiral/roadrunner-laravel](https://github.com/spiral/roadrunner-laravel) ([v5.8.0](https://github.com/spiral/roadrunner-laravel/releases/tag/v5.8.0), 2 days ago) - 🌉 RoadRunner ⇆ Laravel bridge
- [laravel/octane](https://github.com/laravel/octane) ([v1.2.1](https://github.com/laravel/octane/releases/tag/v1.2.1), 4 days ago) - Supercharge your Laravel application&#39;s performance.
