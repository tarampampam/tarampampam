...
- [jetexe/gobuf-docker](https://github.com/jetexe/gobuf-docker) ([v1.52.1](https://github.com/jetexe/gobuf-docker/releases/tag/v1.52.1), 5 days ago) - docker image for buf with golang extensions
